<!DOCTYPE HTML>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Camisa de time para casal</title>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col">
                <i class="bi bi-search"></i> <input type="text" id="" placeholder="Buscar..."/>
                <button id="">Buscar</button> <i class="bi bi-cart"></i>
                </div>
                <div class="col">
                <p>
                    <a href="#" >
            ...
            <div class="row">
                <header class="site-header sticky-top py-1 mb-3">
                ...
                <div class="col-4" id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="pt1.png" class="d-block w-100" alt="..." height: 50px;>
                        </div>
                        <div class="carousel-item">
                            <img src="pt2.jpeg" class="d-block w-100" alt="..." height: 50px;>
                        </div>
                    </div>
                ...
                <div class="col-8">
                    <h4>CONJUNTO CASAL CAMISA FEMININA + CAMISA MASCULINA SELEÇÃO BRASIL MODELO 2019</h4> 
                    <p>4 estrelas  |  5 avaliações  |  500 vendidas</p>
                    <h2>R$287,45</h2>
                    <div class="col-3" style="margin-right: 50px;">
                        <p>Frete</p>
                    </div>
                    <div class="col-9">
                        <p><i class="bi bi-calendar-check" style="color: red;"></i> Encomenda (envio em 30 dias)</p>
                        <p><i class="bi bi-truck" style="color: green;"></i> Frete grátis com cupom<br>
                        Para compras acima de R$29,00</p>
                    </div>
