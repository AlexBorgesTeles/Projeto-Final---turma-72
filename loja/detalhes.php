        ...
        <div class="col-8">
            ...
            <div class="row mt-2">
                <div class="col" style="padding-left: 33px;">
                    <a class="btn btn-outline-danger btn-lg" href="insertcarrinho.php?id_camisa= <?php echo $camisa['id_camisa']; ?>" role="button"><i class="bi bi-cart-plus"></i>Adicionar ao carrinho</a>
                </div>
                <div class="col">
