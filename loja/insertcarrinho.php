...
if (isset($_SESSION["user_id"]) and $_SESSION["user_id"] != "") {
    ...
    header("Location: login.php?carrinho=1");
}
if (isset($_GET["ok"]) and $_GET["ok"] == 1) {
    echo "<div class='alert alert-success alert-dimissible fade show' role='success'>Produto foi retirado do carrinho!<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
}
...
?>
     	<div class='row'>
	     <a id='b1' href='home.php' class='btn btn-warning'> Continuar compra</a>
        
	     <a id='b2' href='fimdecompra.php' class='btn btn-primary'> Finalizar compra</a>
        </div>
        <style>
            #b1 {
                margin-left: 100px;
